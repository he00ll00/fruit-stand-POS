...
<div style="display:flex; gap:20px; align-items:flex-start;">
  ...
  <div style="flex:1; background:white; border:1px solid #4c555e; border-radius:8px; padding:15px;">
    ...
    <div style="margin-top:12px; font-weight:700;">Total: ₱<?= number_format($total_amount,2) ?></div>

    <button type="submit" form="checkoutForm" class="btn btn-primary" <?= empty($cart) ? 'disabled' : '' ?>>Proceed</button>
